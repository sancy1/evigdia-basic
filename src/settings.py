...
#         'CALLBACK_URL',
#         'http://evigdia-basic.onrender.com/accounts/google/login/callback/'  
#     )
...
#     'TITLE': 'Social DM API',
#     'DESCRIPTION': 'API for EvigDia Basic',
#     'VERSION': '1.0.0',
...
def get_cors_origins():
    ...
    base_origins.append('https://evigdia-basic.onrender.com')
